...
print("Welcome to Our Rock-Paper-Scissors CLI game!!")
...
while start_game:
    ...
    if player_choice == computer_choice:
        ...
        print("Oops, ", player_choice, " is an Invalid input....Let's try that again")
    
    
    restart = input("Will you like to play again?\nPress 'y' for yes or 'n' for no.")
    # Restart program
    if restart == "y":
        continue
    else:
